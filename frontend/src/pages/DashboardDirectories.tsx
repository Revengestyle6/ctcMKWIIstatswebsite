...
function DirectoryTable({
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <div className="h-64 animate-pulse rounded-md border border-white/10 bg-white/5" />
      ) : (
        children
      )}
    </DashboardShell>
  ...
  const controls = (
    <div className="flex flex-col gap-3 md:flex-row md:items-end">
      <SeasonDivisionSelector
        ...
        onSeasonChange={scope.setSeason}
        onDivisionChange={scope.setDivision}
      />
      <label className="flex flex-1 flex-col gap-1 text-sm font-semibold text-gray-300">
        Search
        <input
