...
> Dated planning/evidence record. Use the [current roadmap](../roadmap/README.md)
> and source-linked architecture guides to distinguish implemented behavior from
> remaining work. Counts, revisions, prices and deployment IDs below are not live
> measurements. This cleanup did not revalidate cloud resources.
...
[`phase-0-production-baseline.md`](../archive/production-readiness/phase-0-production-baseline.md). Proposed cleanup
dispositions are tracked in
[`repository-cleanup-inventory.md`](../archive/production-readiness/repository-cleanup-inventory.md).
Live Phase 4 resource and checkpoint status is tracked in
[`phase-4-resource-inventory.md`](../operations/phase-4-resource-inventory.md). That inventory is
...
- Playoff support is implemented in the local branch and documented in
  [`playoff-support-implementation.md`](../features/playoff-support-implementation.md). It adds
...
numbers. Older product-roadmap milestones in [`vision.md`](../archive/product-plans/vision.md) predate this
...
- Uploaded team-logo media buckets and least-privilege runtime object access are
  provisioned for staging and production. Staging Cloud Run is configured for its
  bucket; the production bucket and identity grant are ready for the Phase 5
  production service.
...
[`phase-1-repository-cleanup.md`](../archive/production-readiness/phase-1-repository-cleanup.md).
...
[`phase-2-no-change-refactor.md`](../archive/production-readiness/phase-2-no-change-refactor.md).
...
[`phase-3-technical-specification.md`](../archive/production-readiness/phase-3-technical-specification.md). No cloud
